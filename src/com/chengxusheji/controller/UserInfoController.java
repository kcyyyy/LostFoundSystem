...
public class UserInfoController extends BaseController {
	...
	public void list(String user_name,@ModelAttribute("areaObj") Area areaObj,String name,String birthday,String telephone,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		List<UserInfo> userInfoList = userInfoService.queryUserInfo(user_name, areaObj, name, birthday, telephone, page);
	    /*计算总的页数和总的记录数*/
	...
	public String frontlist(String user_name,@ModelAttribute("areaObj") Area areaObj,String name,String birthday,String telephone,Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
	...
	public void OutToExcel(String user_name,@ModelAttribute("areaObj") Area areaObj,String name,String birthday,String telephone, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        if(user_name == null) user_name = "";
        if(name == null) name = "";
        if(birthday == null) birthday = "";
        if(telephone == null) telephone = "";
        ...
        String[] headers = { "学号","所在学院","姓名","性别","学生照片","出生日期","联系电话"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<userInfoList.size();i++) {
        	UserInfo userInfo = userInfoList.get(i); 
        	dataset.add(new String[]{userInfo.getUser_name(),userInfo.getAreaObj().getAreaName(),userInfo.getName(),userInfo.getSex(),userInfo.getUserPhoto(),userInfo.getBirthday(),userInfo.getTelephone()});
        }
        /*
