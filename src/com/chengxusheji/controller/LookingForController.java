...
public class LookingForController extends BaseController {
	...
	/*前台按照用户名查询寻物启事信息*/
	@RequestMapping(value = {"/userFrontList"},method = RequestMethod.GET)
	public String userFrontList(HttpServletRequest request) throws Exception {
		String user_name=request.getParameter("user_name");
		List<LookingFor> list=lookingForService.queryMyLookingfor(user_name);
		UserInfo userInfo=userInfoService.getUserInfo(user_name);
		request.setAttribute("lookingForList", list);
		request.setAttribute("userObj", userInfo);
		return "forward:../user_MessLookingfor.jsp";
